...
```{r, echo=FALSE}
reddCount <- 324 
countDate <- "August 8, 2023"
updatedReddInfoDate <- "August 8, 2023"
#show_extra = TRUE
```
...
setwd("C:/Users/lelliott/OneDrive - DOI/Documents/Projects/Redd Dewatering/2023")
...
Metric <- c("Avg Sept Flow (cfs)", "Avg Oct Flow (cfs)", "Total Volume (TAF)", "Redds dewatered", "Percent Lost", "Redds dewatered (w/ 100cfs buffer)", "Percent Lost (w/ 100cfs buffer)")
...
legend("bottom", inset = c(0, -0.12), legend=c(names(kesFlow)[2:length(kesFlow)], "Emerged", "Dewatered", "Remaining"),
