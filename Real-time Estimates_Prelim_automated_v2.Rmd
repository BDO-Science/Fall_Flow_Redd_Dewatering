...
redd_model <- kesFlowReal %>% 
  gather(key = Scenarios, value = Spawn_Flows, A.1bcfs, A.2ccfs, A.3dcfs, A.3fcfs) %>%
...
flows <- kesFlowReal %>% rename('Alt-1b' = 'A.1bcfs', 'Alt-2c' = 'A.2ccfs', 
                                'Alt-3d' = 'A.3dcfs', 'Alt-3f' = 'A.3fcfs') %>%
  gather(key = 'Alternates', value = 'Flow', 'Alt-1b', 'Alt-2c', 'Alt-3d', 'Alt-3f') %>% 
